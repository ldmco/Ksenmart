...
class KsenMartControllerShopProfile extends JController {

    public function save_user() {
        $model = $this->getModel('shopprofile');
        $this->setMessage($model->saveUser());
        $this->setRedirect(JRoute::_('index.php?option=com_ksenmart&view=shopprofile', false));
    }
    ...
    public function load_order() {
        ...
        $this->setRedirect(JRoute::_('index.php?option=com_ksenmart&view=shopopencart', false));
    }
    ...
    public function getDataShippingModule(){
        ...
        $model      = $this->getModel('shopprofile');
        $view       = $this->getView('shopprofile', 'html');
    ...
    public function setSubscribe(){
        KMUsers::setUserSubscribeGroup(KMUsers::getUser()->id);
    }
