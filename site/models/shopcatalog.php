...
jimport('joomla.application.component.modelkmlist');

/**
 * KsenMartModelShopCatalog
 * 
 * @package   
 * @version 2013
 * @access public
 */
class KsenMartModelShopCatalog extends JModelKMList {
    ...
    /**
     * KsenMartModelShopCatalog::__construct()
     * 
     * @param mixed $config
     * @return
     */
    ...
    /**
     * KsenMartModelShopCatalog::getDefaultStates()
     * 
     * @return
     */
    ...
    /**
     * KsenMartModelShopCatalog::populateState()
     * 
    ...
    /**
     * KsenMartModelShopCatalog::getProductsIds()
     * 
     * @return
     */
    ...
    /**
     * KsenMartModelShopCatalog::getIdsByProperties()
     * 
    ...
    /**
     * KsenMartModelShopCatalog::getIdsByPropertiesV()
     * 
     * @param mixed $properties
     * @return
     */
    private function getIdsByPropertiesV($properties){
        ...
        if(!empty($properties)){
            $properties = KMSystem::getTableByIds($properties, 'property_values', array('t.id', 't.property_id'), false); 
    ...
    /**
     * KsenMartModelShopCatalog::getIdsByPropertiesPV()
     * 
     * @param mixed $properties
     * @return
     */
    ...
    /**
     * KsenMartModelShopCatalog::getProductsIdsBy()
     * 
     * @param mixed $where
     * @return
     */
    private function getProductsIdsBy(array $ids){
        ...
        if(!empty($ids)){
            $products = KMSystem::getTableByIds($ids, 'products', array('t.id', 't.parent_id'));
    ...
    /**
     * KsenMartModelShopCatalog::getIdsByMMPrices()
     * 
    ...
    /**
     * KsenMartModelShopCatalog::getIdsByCategories()
     * 
    ...
    /**
     * KsenMartModelShopCatalog::getIdsByCountries()
     * 
    ...
    /**
     * KsenMartModelShopCatalog::getListQuery()
     * 
     * @return
     */
    ...
    /**
     * KsenMartModelShopCatalog::getFilterProperties()
     * 
     * @return
     */
    ...
    /**
     * KsenMartModelShopCatalog::getFilterManufacturers()
     * 
     * @return
     */
    ...
    /**
     * KsenMartModelShopCatalog::getFilterDefaultParams()
     * 
     * @return
     */
    ...
    /**
     * KsenMartModelShopCatalog::getFilterCountries()
     * 
     * @return
     */
    ...
    /**
     * KsenMartModelShopCatalog::getItems()
     * 
     * @return
     */
    ...
    /**
     * KsenMartModelShopCatalog::getCategory()
     * 
     * @return
     */
    public function getCategory() {
        ...
        if(!empty($this->_categories)){
            ...
            if(!empty($category)){
                $category->image = KMMedia::resizeImage($category->filename, $category->folder, 0, 32, json_decode($category->params, true));
            }
    ...
    /**
     * KsenMartModelShopCatalog::getCategoryTitle()
     * 
     * @return
     */
    public function getCategoryTitle() {
        ...
        $config         = KMSystem::getSeoTitlesConfig('category');
        $title          = array();
    ...
    /**
     * KsenMartModelShopCatalog::getCountry()
     * 
     * @return
     */
    ...
    /**
     * KsenMartModelShopCatalog::getCountryTitle()
     * 
     * @return
     */
    public function getCountryTitle() {
        ...
        $config         = KMSystem::getSeoTitlesConfig('title');
        $title          = array();
    ...
    /**
     * KsenMartModelShopCatalog::getManufacturers()
     * 
     * @return
     */
    public function getManufacturers() {
        ...
        foreach ($manufacturers as &$manufacturer) {
            ...
            $manufacturer->small_img = KMMedia::resizeImage($manufacturer->filename, $manufacturer->folder, $this->_params->get('thumb_width'), $this->_params->get('thumb_height'));
            $manufacturer->link = JRoute::_('index.php?option=com_ksenmart&view=shopcatalog&manufacturers[]=' . $manufacturer->id . '&Itemid=' . KMSystem::getShopItemid() . '&clicked=manufacturers');
        }
    ...
    /**
     * KsenMartModelShopCatalog::getManufacturer()
     * 
     * @return
     */
    ...
    /**
     * KsenMartModelShopCatalog::getManufacturerTitle()
     * 
     * @return
     */
    public function getManufacturerTitle() {
        ...
        $config         = KMSystem::getSeoTitlesConfig('manufacturer');
        $shop_name      = $this->_params->get('shop_name', '');
        $path_separator = $this->_params->get('path_separator', ' ');
    ...
    /**
     * KsenMartModelShopCatalog::getChildCats()
     * 
     * @param mixed $catid
     * @return
     */
    public function getChildCats($catid) {
        ...
        $query
            ...
            ')
            ->from('#__ksenmart_categories AS c')
            ->where('c.parent='.$this->_db->getEscaped($catid))
            ->order('c.ordering')                        
        ;
        $this->_db->setQuery($query);
    ...
    /**
     * KsenMartModelShopCatalog::getCatalogPath()
     * 
     * @return
     */
    ...
    /**
     * KsenMartModelShopCatalog::getCatalogTitle()
     * 
     * @return
     */
    public function getCatalogTitle() {
        ...
        if(!empty($this->_categories)){
            $categories = KMSystem::getTableByIds($this->_categories, 'categories', array('t.id', 't.title'));
        ...
        if(!empty($this->_countries)){
            $countries = KMSystem::getTableByIds($this->_countries, 'countries', array('t.id', 't.title'));
        ...
        if(!empty($this->_manufacturers)){
            $manufactureries = KMSystem::getTableByIds($this->_manufacturers, 'manufacturers', array('t.id', 't.title'));
        ...
        if(!empty($this->_properties)){
            $properties = KMSystem::getTableByIds($this->_properties, 'property_values', array('t.id', 't.title', 't.property_id'), false);
            if(!empty($properties)){
                $props  = array();
                foreach ($properties as $property) {
                    if (!isset($props[$property->property_id])){
                ...
                $property = KMSystem::getTableByIds($props, 'properties', array('t.id', 't.title'), true, true);
    ...
    /**
     * KsenMartModelShopCatalog::setCategoryMetaData()
     * 
     * @return
     */
    public function setCategoryMetaData() {
        ...
        $metakeywords       = '';
        $category           = $this->getCategory();
        $config             = KMSystem::getSeoTitlesConfig('category', 'meta');
    ...
    /**
     * KsenMartModelShopCatalog::setManufacturerMetaData()
     * 
     * @return
     */
    public function setManufacturerMetaData() {
        ...
        $metakeywords       = '';
        $manufacturer       = $this->getManufacturer();
        $config             = KMSystem::getSeoTitlesConfig('manufacturer', 'meta');
        ...
        if (empty($manufacturer->metakeywords)) {
            if ($config->keywords->flag == 1) {
                if ($config->keywords->type == 'seo-type-country') {
                    $countries = KMSystem::getTableByIds(array($manufacturer->country), 'countries', array('t.title'));
    ...
    /**
     * KsenMartModelShopCatalog::setCountryMetaData()
     * 
     * @return
     */
    public function setCountryMetaData() {
        ...
        $metakeywords       = '';
        $country            = $this->getCountry();
        $config             = KMSystem::getSeoTitlesConfig('country', 'meta');
    ...
    /**
     * KsenMartModelShopCatalog::setCatalogMetaData()
     * 
     * @return
     */
    ...
    /**
     * KsenMartModelShopCatalog::getSortLinks()
     * 
     * @return
     */
    public function getSortLinks() {
        ...
        $sort_links = array();
        foreach ($sort as $s) {
            $sort_links[$s['order_type']]['asc_link'] = '<a type="' . $s['order_type'] . '" dir="asc" href="' . JRoute::_('index.php?option=com_ksenmart&view=shopcatalog&order_type=' . $s['order_type'] . '&order_dir=asc' . $params_get) . '"><img src="' . JURI::base() . 'components/com_ksenmart/images/bottomb.png"></a>';
            $sort_links[$s['order_type']]['desc_link'] = '<a type="' . $s['order_type'] . '" dir="desc" href="' . JRoute::_('index.php?option=com_ksenmart&view=shopcatalog&order_type=' . $s['order_type'] . '&order_dir=desc' . $params_get) . '"><img src="' . JURI::base() . 'components/com_ksenmart/images/topb.png"></a>';
            if ($s['order_type'] == $order_type) {
                $class = "active";
                if ($order_dir == 'asc') {
                    $sort_links[$s['order_type']]['asc_link'] = '<a type="' . $s['order_type'] . '" dir="asc" class="' . $class . '" href="' . JRoute::_('index.php?option=com_ksenmart&view=shopcatalog&order_type=' . $s['order_type'] . '&order_dir=asc' . $params_get) . '"><img src="' . JURI::base() . 'components/com_ksenmart/images/bottomba.png"></a>';
                    $class .= " down";
                    $dir = 'desc';
                } else {
                    $sort_links[$s['order_type']]['desc_link'] = '<a type="' . $s['order_type'] . '" dir="desc" class="' . $class . '" href="' . JRoute::_('index.php?option=com_ksenmart&view=shopcatalog&order_type=' . $s['order_type'] . '&order_dir=desc' . $params_get) . '"><img src="' . JURI::base() . 'components/com_ksenmart/images/topba.png"></a>';
                    $dir = 'asc';
                    $class .= " up";
                }
            } else {
            ...
            $sort_links[$s['order_type']]['link'] = '<a type="' . $s['order_type'] . '" dir="' . $dir . '" class="' . $class . '" href="' . JRoute::_('index.php?option=com_ksenmart&view=shopcatalog&order_type=' . $s['order_type'] . '&order_dir=' . $dir . $params_get) . '">' . $s['name'] . '</a>';
        }
    ...
    /**
     * KsenMartModelShopCatalog::sortOnPriceAsc()
     * 
     * @param mixed $a
     * @param mixed $b
     * @return
    ...
    /**
     * KsenMartModelShopCatalog::sortOnPriceDesc()
     * 
     * @param mixed $a
     * @param mixed $b
     * @return
    ...
    /**
     * KsenMartModelShopCatalog::getStart()
     * 
     * @return
     */
    ...
    /**
     * KsenMartModelShopCatalog::setLayoutCatalog()
     * 
     * @param mixed $layout
     * @return
     */
