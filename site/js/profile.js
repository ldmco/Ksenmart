...
jQuery(document).ready(function(){
    ...
    jQuery('.favorities .thumbnails .item .thumbnail .l-lose_t_product, .watched .thumbnails .item .thumbnail .l-lose_t_product').on('click', function(){
        ...
        if(typeof id != 'undefined'){
            jQuery.ajax({
                type: 'POST',
                url: URI_ROOT+'index.php?option=com_ksenmart&tmpl=ksenmart&task=shopprofile.lose_t_product',
                data: {
                    id: id,
                    type: type
                },
    ...
    jQuery('.avatar_edit').on('click', function(e){
        ...
        jQuery.ajax({
            url: URI_ROOT+'index.php?option=com_ksenmart&tmpl=ksenmart&task=shopprofile.loadAvatar',
            data: data,
            cache: false,
            contentType: false,
            processData: false,
	...
	jQuery('.address input[type="radio"]').on('click', function(){
		...
		jQuery.ajax({
			url: URI_ROOT+'index.php?option=com_ksenmart&task=shopprofile.set_default_address&id='+address_id+'&tmpl=ksenmart',
    ...
    jQuery('.save_product_review').on('click', function(){
        ...
        jQuery.ajax({
            type: 'POST',
            url: URI_ROOT+'index.php?option=com_ksenmart&task=shopprofile.updateProductReview&tmpl=ksenmart',
            data: {
                review_id: review_id,
                comment: comment,
                good: good, 
    ...
    jQuery('.save_shop_review').on('click', function(){
        ...
        jQuery.ajax({
            type: 'POST',
            url: URI_ROOT+'index.php?option=com_ksenmart&task=shopprofile.edit_shop_review&tmpl=ksenmart',
            data: {
                id: review_id,
                review: comment
            },
