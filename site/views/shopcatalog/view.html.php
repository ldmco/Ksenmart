...
class KsenMartViewShopCatalog extends JViewKM {
    ...
    function display($tpl = null) {
        ...
        switch($this->getLayout()) {
            ...
            case 'manufacturers':
                ...
                $path->addItem(JText::_('KSM_MANUFACTURERS_PATHWAY_ITEM'), JRoute::_('index.php?option=com_ksenmart&view=shopcatalog&layout=manufacturers'));
