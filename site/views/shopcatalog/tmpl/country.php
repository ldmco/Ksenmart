...
<div class="catalog">
	...
	<?php if (!empty($this->rows)){ ?>
        ...
        <?php foreach($this->rows as $manufacturer){ ?>
    		<li><a href="<?php echo JRoute::_('index.php?option=com_ksenmart&view=shopcatalog&manufacturers[]='.$manufacturer->id.'&clicked=manufacturers');; ?>" title="<?php echo $manufacturer->title; ?>"><?php echo $manufacturer->title; ?></a></li>
    	<?php } ?>
        </ul>
	<?php }else{ ?>
