                ...
                <div class="pos_relative">
    				...
    				<div class="muted row-fluid bottom_info">
                        <div class="span6 brand">
                            <?php if(!empty($product->manufacturer_title)){ ?>
                            Бренд: <a href="index.php?option=com_ksenmart&view=shopcatalog&manufacturers[0]=<?php echo $product->manufacturer; ?>&Itemid=<?php echo KMSystem::getShopItemid(); ?>" title="<?php echo $product->manufacturer_title; ?>"><?php echo $product->manufacturer_title; ?></a>
                            <?php }?>
                        </div>
