    ...
    <?php foreach($this->order->items as $item) { ?>
    		<tr class="row_odd">
    			<td class="vid_produkt">
    				<a class="title_lookp" href="<?php echo JRoute::_(JURI::root() . 'index.php?option=com_ksenmart&view=shopproduct&id=' . $item->product_id . ":" . $item->alias . '&Itemid=' . KMSystem::getShopItemid()); ?>" ><?php echo $item->title; ?></a>
			...
			<td align="center"><?php echo KMPrice::showPriceWithTransform($item->price); ?></td>
			<td align="center" nowrap="nowrap">
				<?php echo KMPrice::showPriceWithTransform($item->count * $item->price); ?>
			</td>
		</tr>
    <?php } ?>
	<tr>
