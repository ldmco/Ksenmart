		...
		<div class="ksm-profile-products-item-button">
			<?php if ($product->catalog_buy): ?> 
				<form class="ksm-catalog-item-buy-form">
					<button type="submit" class="ksm-profile-products-item-button-buy ksm-btn-success"><?php echo JText::_('KSM_PRODUCT_ADDTOCART_BUTTON_TEXT'); ?></button>
			...
			<?php else: ?>
				<a href="<?php echo $product->link; ?>" class="ksm-profile-products-item-button-view ksm-btn"><?php echo JText::_('KSM_READ_MORE'); ?></a>
			<?php endif; ?>
		</div>		
	</div>
	<?php endforeach; ?>
