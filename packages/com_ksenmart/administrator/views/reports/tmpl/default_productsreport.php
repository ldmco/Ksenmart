...
<table class="cat" width="100%" cellspacing="0">	
	<thead>
		<tr>
			...
			<th class="storage"><span class="sort_field" rel="hits"><?php echo JText::_('ksm_reports_product_viewed')?></span></th>
			<th class="storage"><span class="sort_field" rel="carted"><?php echo JText::_('ksm_reports_product_carted')?></span></th>
			<th class="storage"><span class="sort_field" rel="ordered"><?php echo JText::_('ksm_reports_product_ordered')?></span></th>
		</tr>
	</thead>	
	<tbody>
