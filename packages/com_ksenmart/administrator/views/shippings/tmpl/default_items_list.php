...
<table class="cat" width="100%" cellspacing="0">	
	<thead>
		<tr>
			<th class="name stretch sort-handler" align="left"><span class="sort_field" rel="title"><?php echo JText::_('ksm_shippings_shipping_name')?></span></th>
			<th class="shipping_type"><?php echo JText::_('ksm_shippings_shipping_type')?></th>
