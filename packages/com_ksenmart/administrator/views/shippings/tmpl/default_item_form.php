...
<tr class="list_item <?php echo ($this->item->published==0?'disabled':'');?>">
	<td class="name stretch sort-handler">
		...
		<div class="descr">	
			<a class="km-modal" rel='{"x":"90%","y":"90%"}' href="<?php echo JRoute::_('index.php?option=com_ksenmart&view=shippings&layout=shipping&id='.$this->item->id.'&tmpl=component');?>"><?php echo $this->item->title;?></a>
			<p>
				<a class="edit km-modal" rel='{"x":"90%","y":"90%"}' href="<?php echo JRoute::_('index.php?option=com_ksenmart&view=shippings&layout=shipping&id='.$this->item->id.'&tmpl=component');?>"><?php echo JText::_('ksm_edit');?></a>
			</p>
		</div>		
	</td>
	<td class="shipping_type"><?php echo JText::_($this->item->plugin_name)?></td>
