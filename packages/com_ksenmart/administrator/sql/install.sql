...
(1, 'order_new', 1, 1),
(2, 'order_new_unconfirmed', 1, 0),
(3, 'order_done', 1, 1),
(4, 'order_canceled', 1, 0),
(5, 'order_paid', 1, 1),
...
CREATE TABLE IF NOT EXISTS `#__ksenmart_products` (
  ...
  `select_properties` int(1) NOT NULL,
  PRIMARY KEY (`id`),
  FULLTEXT KEY `title` (`title`),
...
(1, 0, 'customer', 'text', 'first_name', 0, 1, 1, 1),
(2, 0, 'customer', 'text', 'last_name', 0, 1, 2, 1),
(3, 0, 'customer', 'text', 'middle_name', 0, 1, 3, 1),
(4, 0, 'customer', 'text', 'phone', 0, 1, 4, 1),
(5, 0, 'customer', 'text', 'email', 0, 1, 5, 1),
(6, 0, 'address', 'text', 'city', 0, 1, 6, 1),
(7, 0, 'address', 'text', 'zip', 0, 1, 7, 1),
(8, 0, 'address', 'text', 'street', 0, 1, 8, 1),
(9, 0, 'address', 'text', 'house', 0, 1, 9, 1),
(10, 0, 'address', 'text', 'entrance', 0, 1, 10, 1),
(11, 0, 'address', 'text', 'floor', 0, 1, 11, 1),
(12, 0, 'address', 'text', 'flat', 0, 1, 12, 1);
...
CREATE TABLE IF NOT EXISTS `#__ksenmart_info` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(1, 0, 'discount', 'fixed'),
(2, 0, 'discount', 'coupons'),
(3, 0, 'discount', 'cumulative'),
(4, 0, 'discount', 'dcshippings'),
(5, 0, 'discount', 'onorder'),
(6, 0, 'shipping', 'pickup'),
(7, 0, 'shipping', 'fixedregions'),
(8, 0, 'shipping', 'redexpress'),
(9, 1, 'payment', 'yandex'),
(10, 0, 'payment', 'courier'),
(11, 0, 'payment', 'receipt'),
(12, 0, 'payment', 'walletone'),
(13, 1, 'shipping', 'b2cpl'),
(14, 1, 'exportimport', '1c_exchange');
...
(7, 'com_ksenmart', 2, 1, 'hide', 'index.php?option=com_ksenmart&view=categories', 'products.png', 'categories', 'categories'),
(8, 'com_ksenmart', 2, 1, 'hide', 'index.php?option=com_ksenmart&view=manufacturers', 'products.png', 'manufacturers', 'manufacturers'),
(9, 'com_ksenmart', 2, 1, 'main', 'index.php?option=com_ksenmart&view=exportimport', 'exportimport.png', 'exportimport', 'exportimport'),
(10, 'com_ksenmart', 0, 2, 'main', 'index.php?option=com_ksenmart&view=payments', 'payments.png', 'payments', 'payments'),
(11, 'com_ksenmart', 0, 3, 'sub', 'index.php?option=com_ksen&view=settings&extension=com_ksenmart', 'settings.png', 'settings', 'settings'),
(12, 'com_ksenmart', 0, 3, 'sub', 'index.php?option=com_ksen&view=seo&extension=com_ksenmart', 'seo.png', 'seo', 'seo'),
(13, 'com_ksenmart', 0, 3, 'sub', 'index.php?option=com_ksenmart&view=countries', 'countries.png', 'countries', 'countries'),
(14, 'com_ksenmart', 0, 3, 'sub', 'index.php?option=com_ksenmart&view=comments', 'comments.png', 'comments', 'comments'),
(15, 'com_ksenmart', 0, 2, 'main', 'index.php?option=com_ksenmart&view=shippings', 'shippings.png', 'shippings', 'shippings'),
(16, 'com_ksenmart', 0, 4, 'sub', 'index.php?option=com_ksen&view=users&extension=com_ksenmart', 'users.png', 'users', 'users');
