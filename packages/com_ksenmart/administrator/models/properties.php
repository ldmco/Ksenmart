...
class KsenMartModelProperties extends JModelKSAdmin {
	...
	function saveProperty($data) {
		...
		$data['range'] = isset($data['range']) ? $data['range'] : 0;
		...
		$on_close = '
			if(typeof window.parent.PropertiesList != "undefined") window.parent.PropertiesList.refreshList();
			if(typeof window.parent.updateProperties != "undefined") window.parent.updateProperties();
		';
