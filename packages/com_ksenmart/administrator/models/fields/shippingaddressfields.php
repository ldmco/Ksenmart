...
class JFormFieldShippingAddressFields extends JFormField {
	...
	public function getInput() {
		...
		jQuery(document).ready(function(){
			...
			jQuery("body").on("click", ".shipping-address-fields .fields-row .del", function(){
				jQuery(this).parents(".row:first").remove();
			});
			jQuery("body").on("click", ".shipping-address-fields .add", function(){
				jQuery("#popup-window-address-fields").show();
				return false;
			});
			jQuery("body").on("change", "#new-address-field-type", function(){
			...
			jQuery("body").on("click", "#popup-window-address-fields .add", function(){
			...
			jQuery("body").on("click", "#popup-window-address-fields .saves", function(){
