...
function KMShowCartMessage(text) {
	...
	var bottom = '<div class="km-message-bottom btn-toolbar row-fluid"><div class="btn-group span6"><a class="link_shop btn btn-info btn-large span12 popup_close">Продолжить покупки</a></div><div class="btn-group span6"><a href="' + km_cart_link + '" target="_top" class="link_cart btn btn-success btn-large span12">Оформить заказ</a></div></div>';
