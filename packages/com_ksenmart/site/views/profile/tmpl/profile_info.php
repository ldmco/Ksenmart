...
<form method="post" class="form-horizontal profile_info" action="#tab2">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name="form[first_name]" id="inputName" class="inputbox" value="<?php echo $this->user->first_name; ?>" placeholder="Ваше имя" required="true" />
		</div>
	</div>
	<div class="control-group">
		<label class="control-label" for="inputName">Ваша фамилия</label>
		<div class="controls">
			<input type="text" name="form[last_name]" id="inputName" class="inputbox" value="<?php echo $this->user->last_name; ?>" placeholder="Ваша фамилия" />
		</div>
	</div>
	<div class="control-group">
		<label class="control-label" for="inputName">Ваше отчество</label>
		<div class="controls">
			<input type="text" name="form[middle_name]" id="inputName" class="inputbox" value="<?php echo $this->user->middle_name; ?>" placeholder="Ваше отчество" />
		</div>
	</div>	
	<div class="control-group">
