...
<div class="mod_ksm_filter ksenmart-search well noTransition <?php echo $class_sfx; ?>" id="ksenmart-search">
	...
	<form action="<?php echo $form_action; ?>" method="get" class="row-fluid">
		...
		<div class="manufacturers brands filter_box display-<?php echo $mod_params['manufacturer']['display']; ?> span4">
		...
		<div class="countries span4 filter_box display-<?php echo $mod_params['country']['display']; ?>">
			<ul class="nav nav-list">
