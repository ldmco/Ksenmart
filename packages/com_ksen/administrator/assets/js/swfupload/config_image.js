...
window.onload = function() {
    var settings_image = {
        flash_url: "components/com_ksen/assets/js/swfupload/swfupload.swf",
        flash9_url: "components/com_ksen/assets/js/swfupload/swfupload_fp9.swf",
        upload_url: "index.php?option=com_ksen&task=media.upload_image&extension=" + KS.extension +"&" + session_name + "=" + session_id + "&" + token + "=1&to=" + upload_to + "&folder=" + upload_folder,
        post_params: {
        ...
        button_image_url: "components/com_ksen/assets/js/swfupload/images/upload.png",
        button_text: '<span class="theFont">' + Joomla.JText._('KS_UPLOAD') + '</span>',
