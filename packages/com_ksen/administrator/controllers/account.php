 ...
 */
class KsenControllerAccount extends KsenController {
    ...
    public function __construct(){
        ...
        $this->_model   = KSSystem::getModel('account', 'ksen');
    ...
    private function setRedirectToIndex($msg = ''){
        ...
        $this->setRedirect('index.php?option=com_ksen&extension='.$extension, $msg);
    }
