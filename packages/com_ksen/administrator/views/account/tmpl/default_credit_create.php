    ...
    jQuery(document).ready(function(){
        ...
        current_popup.parent().on('submit', function(e){
            ...
            if(current_popup.find('input[name="phoneid"]').length != 0){
                var href = 'index.php?option=com_ksen&view=account&tmpl=ksenmart&task=account.createCreditQiwi';
                ...
                var href = 'index.php?option=com_ksen&view=account&tmpl=ksenmart&task=account.createCredit';
