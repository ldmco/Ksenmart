<div class="form" id="settings_form">
    ...
    <div class="row clearfix">
        <label class="inputname">Имя пользователя</label>
        <input type="text" name="name" class="inputbox" required="true" value="<?php echo $this->user_info->name; ?>" />
    </div>
    <div class="row clearfix">
        <label class="inputname">ФИО</label>
        <input type="text" name="realname" class="inputbox" required="true" value="<?php echo $this->user_info->realname; ?>" />
    </div>
    <div class="row clearfix">
        <label class="inputname">E-mail для уведомлений</label>
        <input type="email" name="email" class="inputbox" value="<?php echo $this->user_info->email; ?>" />
    </div>
    <input type="hidden" name="superuser" value="<?php echo $this->user_info->superuser; ?>" />
    <input type="hidden" name="useavatar" value="<?php echo $this->user_info->useavatar; ?>" />
...
<script>
    ...
    jQuery(document).ready(function(){
        ...
        var current_popup   = jQuery('.popup.settings');
        var form            = current_popup.find('#settings_form');
        ...
        current_popup.parent().on('submit', function(e){
            ...
            jQuery.ajax({
                url: root+'index.php?option=com_ksen&tmpl=ksenmart&task=account.loadImages',
                data: data,
                cache: false,
                contentType: false,
                processData: false,
        ...
        current_popup.parent().on('submit', function(e){
            ...
            var href = 'index.php?option=com_ksen&view=account&tmpl=ksenmart&task=account.saveSettings';
            
            var elid        = form.find('input[name="elid"]').val();
            var name        = form.find('input[name="name"]').val();
            var realname    = form.find('input[name="realname"]').val();
            var email       = form.find('input[name="email"]').val();
            var superuser   = form.find('input[name="superuser"]').val();
            var useavatar   = form.find('input[name="useavatar"]').val();
