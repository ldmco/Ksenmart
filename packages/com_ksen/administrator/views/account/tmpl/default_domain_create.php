...
<script>
    ...
    jQuery(document).ready(function(){
        ...
        current_popup.parent().on('submit', function(e){
            ...
            var href = 'index.php?option=com_ksen&view=account&tmpl=ksenmart&task=account.createdomain';
    ...
    function registrationDomain(){
        ...
        var href = 'index.php?option=com_ksen&view=account&tmpl=ksenmart&task=account.registerDomains';
    ...
    function sendSelectedDomains(e){
        ...
        var href = 'index.php?option=com_ksen&view=account&tmpl=ksenmart&task=account.registerDomainsData';
    ...
    function getVariantsDomains(){
        var href = 'index.php?option=com_ksen&view=account&tmpl=ksenmart&task=account.checkDomains';
