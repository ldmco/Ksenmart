        ...
        <div class="wrapp clearfix">
            <div class="icon_block">
                <a href="javascript:void(0);" title="Мои Сообщения">
                    <img src="./components/com_ksen/assets/images/mail.png" height="85" />
                </a>
            </div>
            <div class="content">
        ...
        <div class="wrapp clearfix">
            <div class="icon_block">
                <a href="javascript:void(0);" title="Движения по счету">
                    <img src="./components/com_ksen/assets/images/balans.png" height="85" />
                </a>
            </div>
            <div class="content">
        ...
        <div class="wrapp clearfix full_height">
            <div class="icon_block">
                <a href="javascript:void(0);" title="Хостинг">
                    <img src="./components/com_ksen/assets/images/Hardware.png" height="85" />
                </a>
            </div>
            <div class="content">
        ...
        <div class="wrapp clearfix full_height">
            <div class="icon_block">
                <a href="javascript:void(0);" title="Домены">
                    <img src="./components/com_ksen/assets/images/domain.png" height="85" />
                </a>
            </div>
            <div class="content">
        ...
        <div class="wrapp clearfix full_height">
            <div class="icon_block">
                <a href="javascript:void(0);" title="Создать тикет">
                    <img src="./components/com_ksen/assets/images/support.png" height="85" />
                </a>
            </div>
            <div class="content">
