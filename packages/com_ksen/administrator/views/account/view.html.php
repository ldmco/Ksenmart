...
class KsenViewAccount extends JViewKSAdmin {
    ...
    public function display($tpl = null) {
        ...
        $this->document->addStyleSheet(JURI::base() . 'components/com_ksen/assets/css/account.css');
        ...
        if(!$model_account->checkAuthorize() && $layout != 'default_login'){
            ...
            if($popup == 'popup'){
                exit(json_encode(array('redirect' => 'index.php?option=com_ksen&view=account&layout=default_login')));
            }
            
            $app->redirect('index.php?option=com_ksen&view=account&layout=default_login');
        }
