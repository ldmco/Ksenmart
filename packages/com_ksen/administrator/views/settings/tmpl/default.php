...
<div id="cat">
    ...
    <div class="right-column">
        <div class="right-column-wra">
            <form action="<?php echo JRoute::_('index.php?option=com_ksen'); ?>" id="settings-form" method="post"
                  class="form" name="adminForm" autocomplete="off" class="form-validate">
                    ...
                    <tr>
                        <td class="rightcol" style="background:#f9f9f9!important;padding-top:15px;">
							<?php foreach ($this->form as $formname => $form): ?>
                                <div class="settings-tab-content" id="settings-<?php echo $formname; ?>-content">
									...
									<?php foreach ($fieldSets as $name => $fieldSet): ?>
                                        <div class="config-option-list settings-sub-tab-content"
                                             id="settings-sub-<?php echo $name ?>-content">
                            ...
                            <input type="hidden" name="extension"
                                   value="<?php echo $this->state->get('extension'); ?>"/>
