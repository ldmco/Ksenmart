		...
		<thead>
			<tr>
				<th align="left" style="position:relative;">
					<?php echo JText::_('ks_seo-titles-config-'.$config_key)?>
			...
			<td class="rightcol" style="background:#f9f9f9!important;padding-top:15px;">
				<div class="row">
					<div class="seo-blocks">
						...
						<div class="seo-block <?php echo ($block_config->activable?'seo-block-activable':'')?> <?php echo ($block_config->sortable?'seo-block-sortable':'')?> <?php echo (!$block_config->active?'inactive':'')?>" alt="<?php echo ($block_config->user==1?$block_config->title:JText::_('ks_'.$key.'-titles-example'));?>">
						...
						<div class="seo-block-bottom">
							...
							<a class="add" href="<?php echo JRoute::_('index.php?option=com_ksen&view=seo&layout=seotitlevalue&tmpl=component&extension='.$this->state->get('extension'));?>"><?php echo JText::_('ks_add')?></a>
						</div>	
					</div>
				</div>
			</td>
