...
<section class="shop_reviews_module<?php echo $moduleclass_sfx; ?>">
    ...
    <div class="row-fluid more">
        <a class="exclusive" href="<?php echo JRoute::_('index.php?option=com_ksenmart&view=comments&layout=shopreviews'); ?>" title="<?php echo JText::_('MODULE_KM_SHOP_REVIEWS_ALL_REVIEWS'); ?>"><?php echo JText::_('MODULE_KM_SHOP_REVIEWS_ALL_REVIEWS'); ?></a>
    </div>
</section>
<?php } ?>