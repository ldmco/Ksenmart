	...
	<div class="controls">
		...
		<?php }else{ ?>
            <?php if($customer_field->title != 'phone'){ ?>
                <input type="text" class="inputbox" <?php echo ($customer_field->system?'id="customer_'.$customer_field->title.'"':'');?> name="customer_fields[<?php echo $customer_field->system?$customer_field->title:$customer_field->id; ?>]" value="<?php echo $customer_field->value; ?>"<?php echo $customer_field->required?' required="true"':''; ?> />
            <?php }else{ ?>
				<input type="text" id="customer_phone" name="customer_fields[<?php echo $customer_field->system?$customer_field->title:$customer_field->id; ?>]" value="<?php echo $customer_field->value; ?>" required="true" />
            <?php } ?>
		<?php } ?>
    </div>
</div>
