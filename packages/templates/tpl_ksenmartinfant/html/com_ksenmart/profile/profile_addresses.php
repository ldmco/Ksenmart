...
<p class="lead add_address"><a href="javascript:void(0);" class="link_b_border btn"><span>+</span> Добавить новый адрес</a></p>
<div class="items">
			...
			<tr class="expnd" data-tr="<?php echo $address->id; ?>">
				...
				<td>
					<label class="radio address">
						<input type="radio" class="radio" name="default_address" data-address_id="<?php echo $address->id; ?>" id="default_<?php echo $address->id; ?>" value="1"<?php echo ($address->default==1?' checked':'')?> />
