...
<div class="search">
    <form action="<?php echo JRoute::_('index.php?option=com_ksenmart&view=search&Itemid='.$Itemid); ?>" method="get" id="simple-search-form">
        <div class="input-append row-fluid">
            <div class="span11"><input type="search" class="inputbox " name="value" placeholder="<?php echo JText::_('MOD_KM_SIMPLE_SEARCH_SEARCHFIELD_PLACEHOLDER'); ?>" value="<?php echo $value; ?>" autocomplete="off" /></div>
            <div class="span1"><button type="submit" class="button btn"><b></b><span><?php echo JText::_('MOD_KM_SIMPLE_SEARCH_SEARCH'); ?></span></button></div>
        </div>
