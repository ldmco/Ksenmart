...
<div id="catalog">
	...
	<div id="review">
		...
		<div class="txt">
			...
			<div class="product">
				<a href="<?php echo JRoute::_('index.php?option=com_ksenmart&view=shopproduct&id='.$this->comment->product.'&Itemid='.KsenmartHelper::getShopItemid())?>"><div style="<?php echo $this->comment->product_img_div_style;?>"><img style="<?php echo $this->comment->product_img_div_style;?>" src="<?php echo $this->comment->product_img;?>" alt=""></div></a>
			</div>	
			<?php endif;?>		
