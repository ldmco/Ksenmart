    ...
    <div class="row-fluid brands js-brands noTransition">
        <?php foreach($this->brands as $country => $brands){ ?>
        	...
        	<?php foreach($brands as $brand){ ?>
        		<li><a href="<?php echo JRoute::_('index.php?option=com_ksenmart&view=shopcatalog&manufacturers[]='.$brand->id); ?>" title="<?php echo $brand->title; ?>"><?php echo $brand->title; ?></a></li>
        	<?php } ?>
        	</ul>
        <?php } ?>
    </div>
