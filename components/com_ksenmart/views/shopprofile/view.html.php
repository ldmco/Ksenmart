...
class KsenMartViewShopProfile extends JViewKM {
    public function display($tpl = null) {
        ...
        switch ($layout) {
            ...
            case 'profile_order':
                ...
                if(!JFactory::getConfig()->getValue('config.caching', 0)) {
                    $path->addItem(JText::_('profile_orders'), 'index.php?option=com_ksenmart&view=shopprofile&layout=profile_orders');
            ...
            default:
                ...
                $this->assign('model_shopprofile', $model);
                $this->assign('show_shop_review', KMSystem::issetReview($user->id));
