...
<div class="items">
	<div class="new_address noTransition" style="display: none;">
		<form method="post" class="form-horizontal" action="#tab3">
			...
			<input type="hidden" name="task" value="shopprofile.add_address" />
		</form>
        <hr />
	</div>
	...
	<table class="table table-hover adresses">
		...
		<tbody>
			...
			<tr class="expnd" data-tr="<?php echo $address->id; ?>">
				<td>
					<a href="<?php echo JRoute::_('index.php?option=com_ksenmart&task=shopprofile.del_address&id='.$address->id.'#tab3'); ?>" title="Удалить адрес"><i class="icon-remove-circle"></i></a>
				</td>
				<td><?php echo KMSystem::formatAddress($address); ?></td>
				<td>
					...
					<input type="hidden" id="address_<?php echo $address->id; ?>" value="<?php echo KMSystem::formatAddress($address); ?>" />
                ...
                <td colspan="3">
                	<div class="noTransition">
                		<form method="post" class="form-horizontal" action="#tab3">
                			...
                			<input type="hidden" name="task" value="shopprofile.edit_address" />
                		</form>
                	</div>
                </td>
            </tr>
