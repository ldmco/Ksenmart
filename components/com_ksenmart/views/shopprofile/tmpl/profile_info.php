...
<form method="post" class="form-horizontal profile_info" action="#tab2">
	<?php if (!in_array(KMUsers::getSubscribersGroupID(), $this->user->groups)) { ?>
	...
	<div class="control-group">
		<div class="controls custom">
			<label class="checkbox">
				<input type="checkbox" name="sendEmail" id="sendEmail" <?php echo (in_array(KMUsers::getSubscribersGroupID(), $this->user->groups)?'checked':''); ?> /> Хочу стать подписчиком
			</label>
	...
	<input type="hidden" name="task" value="shopprofile.save_user" />
</form>