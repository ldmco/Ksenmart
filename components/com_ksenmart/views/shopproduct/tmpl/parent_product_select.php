				...
				<div class="options">
					<div class="row">
						...
						<div class="prop">
							...
							{
							?>
							<option value="<?php echo JRoute::_('index.php?option=com_ksenmart&view=shopproduct&id='.$child->id.':'.$child->alias)?>" <?php echo ($child->id==$this->product->id?'selected':'')?>><?=$child->title?></option>
							<?
							}
							?>
							</select>	
