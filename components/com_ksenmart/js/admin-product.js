jQuery(document).ready(function(){
	...
	jQuery('.photo-title').live('click',function(){
		jQuery(this).hide();
		jQuery(this).parent().find('input[type="text"]').show();
	});		
	
	jQuery('.del_photo').live('click',function(){
	...
	jQuery('.show_video').live('click',function(){
	...
	jQuery('.video_frame_head .close').live('click',function(){
	...
	jQuery('.del_video').live('click',function(){
	...
	jQuery('.related_products_search_results .move_related').live('click',function(){
	...
	jQuery('.related_products_info .move_related').live('click',function(){
		jQuery(this).parent().parent().remove();
		if (jQuery('.related_products_info li').length==1)
			jQuery('.related_products_info li[id="0"]').removeClass('hide');
	});		
	
	jQuery('.ksenmart-categories li span').live('click',function(){
	...
	jQuery('.ksenmart-collections li').live('click',function(){
	...
	jQuery('.ksenmart-manufacturers li').live('click',function(){
		if (jQuery(this).is('.active'))
		{
			jQuery(this).removeClass('active');
		}	
