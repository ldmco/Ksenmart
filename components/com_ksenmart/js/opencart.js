jQuery(document).ready(function(){
    ...
    jQuery('body').on('click', '.select_address tr', function(e){
        ...
        jQuery.ajax({
            type: 'POST',
            url: URI_ROOT+'index.php?option=com_ksenmart&task=shopopencart.set_select_address_id&tmpl=ksenmart',
            data: {
                id    : id,
                city  : city,
                street: street,
...
function update_prices(){
	...
	var data={};
	data['layouts']   = {'0':'default_on_display_after_content', '1':'default_total'};
...
function setOrderUserField(name, field_value){
	jQuery.ajax({
		url: URI_ROOT+'index.php?option=com_ksenmart&task=shopopencart.updateOrderUserField&tmpl=ksenmart',
		type: 'POST',
        data: {name: name, field_value: field_value},
		success: function(data){}
	});
}
...
function setOrderField(column, field){
	jQuery.ajax({
		url: URI_ROOT+'index.php?option=com_ksenmart&task=shopopencart.updateOrderField&tmpl=ksenmart',
		type: 'POST',
        data: {column: column, field: field},
		success: function(data){}
	});
}
...
function KMCartChangeRegion(obj){
	...
	data['layouts']   = {'0':'default_shipping', '2':'default_payments', '1':'default_total'};
...
function KMCartChangeShipping(obj){
	...
	data['layouts']     = {'0':'default_shipping', '1':'default_total'};
