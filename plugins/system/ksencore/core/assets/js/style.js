...
function cuSel(a) {
    function b() {
        ...
        jQuery("html").on('click', function(a) {
        ...
        jQuery(".cusel").keydown(function(a) {
            ...
            if (b == 40) {
                ...
                if (f.is("span")) {
                    ...
                    jQuery(this).find("input").eq(0).val(f.attr("val"));
                    cuselScrollToCurent(jQuery(this).find(".cusel-scroll-wrap").eq(0));
                    return false
                } else return false
            }
            if (b == 38) {
                ...
                if (cuselActivePrev.is("span")) {
                    ...
                    jQuery(this).find("input").eq(0).val(cuselActivePrev.attr("val"));
                    cuselScrollToCurent(jQuery(this).find(".cusel-scroll-wrap").eq(0));
                    return false
                } else return false
            }
            if (b == 27) {
                var g = jQuery(this).find(".cuselActive").eq(0).text();
                jQuery(this).removeClass("cuselOpen").find(".cusel-scroll-wrap").eq(0).css("display", "none").end().find(".cuselOptHover").eq(0).removeClass("cuselOptHover");
                jQuery(this).find(".cuselText").eq(0).text(g)
            }
            if (b == 13) {
                var h = jQuery(this).find(".cuselOptHover").eq(0);
                if (h.is("span")) {
                    jQuery(this).find(".cuselActive").removeClass("cuselActive");
                    h.addClass("cuselActive")
                } else var i = jQuery(this).find(".cuselActive").attr("val");
                jQuery(this).removeClass("cuselOpen").find(".cusel-scroll-wrap").eq(0).css("display", "none").end().find(".cuselOptHover").eq(0).removeClass("cuselOptHover");
                jQuery(this).find("input").eq(0).change()
            }
            if (b == 32 && jQuery.browser.opera) {
                var j = jQuery(this).find(".cusel-scroll-wrap").eq(0);
                cuselShowList(j)
            }
            ...
            function g() {
                ...
                for (g = 0; g < f; g++) {
                    ...
                    if (i) {
                        ...
                        cuselScrollToCurent(jQuery(e).find(".cusel-scroll-wrap").eq(0));
                        a = a.splice;
                        a = [];
                        break;
                        return true
    ...
    jQuery(a.changedEl).each(function(c) {
        ...
        var r = d.data("events"),
            s = [];
        if (r && r["change"]) {
            jQuery.each(r["change"], function(a, b) {
                s[s.length] = b
            })
        }
        if (!m) {
