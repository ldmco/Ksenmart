...
<tr class="list_item">
	...
	<td class="order_cost" align="center"><?php echo KMPrice::showPriceWithTransform($this->item->cost)?></td>
	<td class="order_date" align="center"><?php echo KMFunctions::formatDate($this->item->date_add)?></td>
