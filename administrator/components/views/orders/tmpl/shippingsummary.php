...
<tr>
	<td>
		...
		<p>
		<strong style="font-size: 120%;" class="inline_edit"><?php echo KMShipping::getShippingName($this->order->shipping_id)?></strong></p>
		<p><?php echo JText::_('ksm_orders_order_addressfields_lbl')?>:</p>
		<span class="inline_edit"><?php echo KMOrders::getPrintformCustomerAddress($this->order->address_fields);?></span><br />
	...
	<td valign="top">
		...
		<p><?php echo JText::_('ksm_payments')?>: <strong class="inline_edit"><?php echo KMPayments::getPaymentName($this->order->payment_id)?></strong></p>
		<p><?php echo JText::_('ksm_shippings')?>: <strong class="inline_edit"><?php echo KMShipping::getShippingName($this->order->shipping_id)?></strong></p>
