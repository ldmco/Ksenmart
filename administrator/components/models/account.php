 ...
 * @access public
 */
class KsenMartModelAccount extends JModelKMAdmin {
    ...
    public function checkDomains() {
        ...
        $c_credit = json_decode(KMSystem::getLdmApiData('domains', 'check', $params));
    ...
    private function resizeAvatarOnLDM($tmp_name, $x1, $y1, $w, $h, $boundx, $boundy){
        ...
        $response = json_decode(KMSystem::getLdmApiData('avatars', null, $params));
        return $response;
    }
