...
class JFormFieldRate extends JFormField{
	...
	public function getInput(){
		...
		{
			$html.='<label>';
			if (floor($this->value)>=$k)
				$html.='<img rel="'.$k.'" src="'.JURI::base().'components/com_ksenmart/css/i/c-star.png" alt="" />';
			else
				$html.='<img rel="'.$k.'" src="'.JURI::base().'components/com_ksenmart/css/i/c-star2.png" alt="" />';
