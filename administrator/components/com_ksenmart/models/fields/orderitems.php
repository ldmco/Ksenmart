...
class JFormFieldOrderItems extends JFormField {
	...
	public function getInput() {
		...
		$script='
		jQuery(".order-positions .add").live("click",function(){
		...
		jQuery(".order-positions .quants .minus").live("click",function(){
		...
		jQuery(".order-positions .quants .plus").live("click",function(){
			var item=jQuery(this).parents(".position:first");
			var	count=parseFloat(item.find(".quants .inputbox").val());
			var product_packaging=parseFloat(item.find(".product_packaging").val());
			count = Math.ceil(count/product_packaging)*product_packaging;
		...
		jQuery(".order-positions .quants .inputbox").live("keypress",function(e){
			if (e.keyCode==13)
			{	
				var item=jQuery(this).parents(".position:first");
				var	count=parseFloat(item.find(".quants .inputbox").val());
		...
		jQuery(".order-positions .del").live("click",function(){
		...
		jQuery(".order-positions .properties input").live("change",function(){
			onChangeItems();	
		});		
