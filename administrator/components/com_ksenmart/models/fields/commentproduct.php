	...
	public function getInput(){
		...
		if ($this->value>0)
		{
			...
			if (!count($product))
			{
				...
				$product->small_img = KMMedia::resizeImage('','products',$params->get('admin_product_medium_image_width'),$params->get('admin_product_medium_image_heigth'));
			}
			else
				$product->small_img = KMMedia::resizeImage($product->filename,$product->folder,$params->get('admin_product_thumb_image_width'),$params->get('admin_product_thumb_image_heigth'),json_decode($product->params,true));
