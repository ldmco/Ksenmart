...
class JFormFieldProductChilds extends JFormField {
	...
	public function getInput() {
		...
		jQuery(document).ready(function(){
			...
			jQuery(".positions-group .sh").live("click",function(){
			...
			jQuery(".position .delete-pos").live("click",function(){
			...
			jQuery(".position .checkbox").live("click",function(){
				var item=jQuery(this).parents(".position:first");
				if (item.is(".active"))
			...
			jQuery(".position .inputbox").live("click",function(){
				jQuery(this).focus();
			});
