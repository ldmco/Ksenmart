...
<div class="position">
	...
	<div class="col3">
		...
		<div class="total"><?php echo JText::_('ksm_orders_order_item_total_price').KMPrice::showPriceWithTransform($this->item->val_price_wou*$this->item->product_packaging);?></div>
	</div>
	<a class="del" href="#"></a>
