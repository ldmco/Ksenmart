	...
	<tr>
		...
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			...
			<tr>
				...
				<td width="100%" class="reportSmallFont underlined"><b class="inline_edit">По заказу № <?php echo $this->order->id?> от <?php echo KMOrders::getPrintformDate($this->order->date_add)?> г.</b></td>
			</tr>
			<tr>
				<td colspan=2>&nbsp;</td>
		</table>
...
<table width="100%" border="0" cellpadding=0 cellspacing=0
	...
	<tr>
		...
		<td class="b_left b_bottom rightAlign nobr"><?php echo KMPrice::showPriceWithoutTransform($item->price)?></td>
		<td class="b_left b_bottom rightAlign nobr"><?php echo KMPrice::showPriceWithoutTransform($item->price*$item->count*(100-$this->params->get('printforms_nds'))/100)?></td>
		<td class="b_left b_bottom"><?php echo $this->params->get('printforms_nds')?></td>
		<td class="b_left b_bottom rightAlign"><?php echo KMPrice::showPriceWithoutTransform($item->price*$item->count*$this->params->get('printforms_nds')/100)?></td>
		<td class="b_left b_bottom b_right rightAlign nobr"><?php echo KMPrice::showPriceWithoutTransform($item->price*$item->count)?></td>
	</tr>
	...
	<tr>
		...
		<td class="b_left b_bottom">X</td>
		<td class="b_left b_bottom rightAlign nobr"><?php echo KMPrice::showPriceWithoutTransform($this->order->cost*(100-$this->params->get('printforms_nds'))/100)?></td>
		<td class="b_left b_bottom">X</td>
		<td class="b_left b_bottom rightAlign nobr"><?php echo KMPrice::showPriceWithoutTransform($this->order->cost*$this->params->get('printforms_nds')/100)?></td>
		<td class="b_left b_bottom b_right rightAlign nobr"><?php echo KMPrice::showPriceWithoutTransform($this->order->cost)?></td>
	</tr>
	<tr class=totals>
		...
		<td class="b_left b_bottom rightAlign nobr"><?php echo KMPrice::showPriceWithoutTransform($this->order->cost*(100-$this->params->get('printforms_nds'))/100)?></td>
		<td class="b_left b_bottom normalFont">X</td>
		<td class="b_left b_bottom rightAlign"><?php echo KMPrice::showPriceWithoutTransform($this->order->cost*$this->params->get('printforms_nds')/100)?></td>
		<td class="b_left b_bottom b_right rightAlign nobr"><?php echo KMPrice::showPriceWithoutTransform($this->order->cost)?></td>
	</tr>
</table>
...
<table width="100%" border="0" cellpadding=0 cellspacing=0
	...
	<tr>
		...
		<td style="width: 40%" class=underlined><b><?php echo KMFunctions::number2string($total_count,1)?></b></td>
...
<table border=0 cellpadding=0 cellspacing=0 width="100%">
	<tr>
		...
		<table width="100%" border="0" cellpadding=0 cellspacing=0
			...
			<tr>
				<td class="underlined leftAlign"><b><?php echo KMFunctions::stringView($this->order->cost)?>, <?php echo ($this->params->get('printforms_nds')!=0?'в т.ч. НДС':'без налога (НДС)')?></b></td>
			</tr>
			<tr>
				<td class=separatorCell>&nbsp;</td>
			</tr>
