	...
	<tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
			...
			<tr>
				...
				<td class="w1 strongtext inline_edit"><?php echo KMOrders::getPrintformDate($this->order->date_add)?></td>
			</tr>
			<tr>
				<td class="w1">Плательщик:</td>
				<td class="middeltext greytext">
				<p class="inline_edit"><?php echo KMOrders::getPrintformCustomerName($this->order->customer_fields);?></p>
				<p class="inline_edit"><?php echo KMOrders::getPrintformCustomerAddress($this->order->address_fields);?></p>
				</td>
				<td>&nbsp;</td>
			</tr>
			<tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
			...
			<tr class="odd">
				...
				<td class="nobr"><?php echo KMPrice::showPriceWithoutTransform($item->price*$item->count)?></td>
			</tr>
			<?php $k++;?>
			<?php endforeach;?>
