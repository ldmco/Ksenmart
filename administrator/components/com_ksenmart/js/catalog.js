jQuery(document).ready(function(){
	...
	jQuery('.prod-parent-closed').on('click',function(){
	...
	jQuery('.prod-parent-opened').on('click',function(){
	...
	jQuery('.prod-set-closed').on('click',function(){
		var item=jQuery(this).parents('.list_item');
		var data={};
		data['id']=item.find('.id').val();
	...
	jQuery('.prod-set-opened').on('click',function(){
		var id=jQuery(this).parents('.list_item').find('.id').val();
	...
	jQuery('.list_item .add_to_set').on('click',function(){
