jQuery(document).ready(function(){
	...
	jQuery('#products_cats li span').live('click',function(){
	...
	jQuery('.show_cat').live('click',function(){
	...
	jQuery('.hide_cat').live('click',function(){
		var cat_id=jQuery(this).parent().parent().attr('cat_id');
	...
	jQuery('#save_yandeximport').click(function(){
		...
		ShowLoading();
		jQuery.post('index.php?option=com_ksenmart&view=yandeximport&task=yandeximport.save',form.serialize(),function(){HideLoading();})
	});
