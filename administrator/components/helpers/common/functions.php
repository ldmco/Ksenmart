...
class KMFunctions {
    ...
    public static function getAddToCartLink() {
        ...
        if($params->get('order_process', 0) == 1) {
            ...
            if($order_id == 0) $add_link_cart = JRoute::_('index.php?option=com_ksenmart&view=shopopenorder&Itemid=' . $Itemid);
            else  $add_link_cart = JRoute::_('index.php?option=com_ksenmart&view=shopopencart&Itemid=' . $Itemid);
        } else  $add_link_cart = JRoute::_('index.php?option=com_ksenmart&view=shopopencart&Itemid=' . $Itemid);
    ...
    public static function stringView($amount) {
        ...
        if($billions > 0) {
            ...
            $s .= KMFunctions::number2string($billions, 1) . " миллиард{$t} ";
        }
        if($millions > 0) {
            $t = "ов";
            $temp = $millions % 10;
            ...
            $s .= KMFunctions::number2string($millions, 1) . " миллион{$t} ";
        }
        if($grands > 0) {
            $t = "";
            $temp = $grands % 10;
            ...
            $s .= KMFunctions::number2string($grands, 0) . " тысяч{$t} ";
        }
        if($roubles > 0) {
            $rub = "ей";
            $temp = $roubles % 10;
            ...
            $s .= KMFunctions::number2string($roubles, 1) . " рубл{$rub} ";
        }
        {
            $kp = "ек";
            $temp = $kop % 10;
