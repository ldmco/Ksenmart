jQuery(document).ready(function(){
	...
	jQuery('.ksenmart-sendmail_templates li label').live('click',function(){
	...
	jQuery('.ksenmart-user_groups li span').live('click',function(){
		if (jQuery(this).parent().is('.active'))
		{
			jQuery(this).parent().removeClass('active');
		}	
	...
	jQuery('.ksenmart-sendmail_templates label').live('mouseover',function(){
		jQuery(this).find('p').css('visibility','visible');
	});
	
	jQuery('.ksenmart-sendmail_templates span').live('mouseout',function(){
		jQuery(this).find('p').css('visibility','hidden');
	});	

	jQuery('.ksenmart-sendmail_templates .delete').live('click',function(){
	...
	jQuery('.ksenmart-sendmail_templates .add').live('click',function(){
		var width=840;
		var height=510;		
	...
	jQuery('.ksenmart-sendmail_templates .edit').live('click',function(){
