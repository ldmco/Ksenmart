...
class KsenMartModelYaMarket extends JModelKMAdmin{
    ...
    public function getUserParams($uid)
    {
        ...
        if(!empty($uid) & $uid > 0){
            ...
            $params = json_decode(KMSystem::getLdmApiData('user', null, $params));
    ...
    public function getUserShopInfo($sid)
    {
        ...
        if(!empty($sid) & $sid > 0){
            ...
            $shop_info = KMSystem::getYaMarketData($function);
    ...
    public function getShopOffers()
    {
        ...
        if(!empty($this->_sid) && $this->_sid > 0){
            ...
            $offers = KMSystem::getYaMarketData($function);
    ...
    public function getShopBalance()
    {
        ...
        if(!empty($this->_sid) && $this->_sid > 0){
            ...
            $balance = KMSystem::getYaMarketData($function);
    ...
    public function getShopStatistic()
    {
        ...
        if(!empty($this->_sid) && $this->_sid > 0){
            ...
            $statistic = KMSystem::getYaMarketData($function, 'GET', $params);
    ...
    public function getTest()
    {
        ...
        if(!empty($this->_sid) && $this->_sid > 0){
            ...
            $test = KMSystem::getYaMarketData2($function);
