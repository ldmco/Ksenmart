...
class JFormFieldShippingCustomerFields extends JFormField {
	...
	public function getInput(){
		...
		jQuery(document).ready(function(){
			jQuery(".shipping-user-fields .fields-row .cb-enable").live("click",function(){
			...
			jQuery(".shipping-user-fields .fields-row .cb-disable").live("click",function(){
				jQuery(this).addClass("selected");
				jQuery(this).parents(".row:first").find(".cb-enable").removeClass("selected");			
				jQuery(this).parents(".row:first").find(".published").val("0");
			});				
			jQuery(".shipping-user-fields .fields-row .del").live("click",function(){
				jQuery(this).parents(".row:first").remove();
			});
			jQuery(".shipping-user-fields .add").live("click",function(){
				jQuery("#popup-window-user-fields").show();
				return false;
			});
			jQuery("#new-user-field-type").live("change",function(){
			...
			jQuery("#popup-window-user-fields .add").live("click",function(){
			...
			jQuery("#popup-window-user-fields .saves").live("click",function(){
