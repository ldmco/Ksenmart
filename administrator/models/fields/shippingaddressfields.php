...
class JFormFieldShippingAddressFields extends JFormField {
	...
	public function getInput(){
		...
		jQuery(document).ready(function(){
			jQuery(".shipping-address-fields .fields-row .cb-enable").live("click",function(){
			...
			jQuery(".shipping-address-fields .fields-row .cb-disable").live("click",function(){
				jQuery(this).addClass("selected");
				jQuery(this).parents(".row:first").find(".cb-enable").removeClass("selected");			
				jQuery(this).parents(".row:first").find(".published").val("0");
			});				
			jQuery(".shipping-address-fields .fields-row .del").live("click",function(){
				jQuery(this).parents(".row:first").remove();
			});
			jQuery(".shipping-address-fields .add").live("click",function(){
				jQuery("#popup-window-address-fields").show();
				return false;
			});
			jQuery("#new-address-field-type").live("change",function(){
			...
			jQuery("#popup-window-address-fields .add").live("click",function(){
			...
			jQuery("#popup-window-address-fields .saves").live("click",function(){
