...
class JFormFieldImages extends JFormField {
	...
	public function getInput(){
		...
		foreach ($this->value as $file) {
			...
			$thumb_url = KMMedia::resizeImage($source_filename,$file->folder,$cparams->get('admin_product_medium_image_width',120),$cparams->get('admin_product_medium_image_height',120),$params);
		...
		{		
			...
			$html.='</div>';	
			$html=KMSystem::wrapFormField('slidemodule',$this->element,$html);
		}
