		...
		<div class="price tracks act">
			<fieldset>
				<div class="inputs">
					...
					<span><?php echo JText::_('MOD_KM_FILTER_PRICE_MORE')?></span><?php echo KMPrice::showPriceWithoutTransform('<input type="text" id="search-price-more" class="search-price" name="price_more" value="'. $price_more .'" />')?>
				</div>
				<div class="tracker">
					<div id="track1"></div>
				</div>				
