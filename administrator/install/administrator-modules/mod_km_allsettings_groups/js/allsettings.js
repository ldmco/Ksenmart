jQuery(document).ready(function(){
	...
	jQuery('.ksenmart-settings-groups .settings-tab').each(function(){jQuery(this).find('li:first').addClass('active');});
	jQuery('.settings-tab-content').hide();
	jQuery('.settings-tab-content:first').show();
	jQuery('.settings-sub-tab-content').hide();
	jQuery('.settings-tab-content').each(function(){jQuery(this).find('.settings-sub-tab-content:first').show();});	

	jQuery('.ksenmart-settings-groups .settings-tab label').live('click',function(){
	...
	jQuery('.ksenmart-settings-groups .settings-sub-tab').live('click',function(){
