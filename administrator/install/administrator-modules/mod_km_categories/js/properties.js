...
jQuery(document).ready(function(){
	...
	CategoriesModule.list=PropertiesList;
	
	jQuery('.mod_km_categories ul li a.show').live('click',function(){
	...
	jQuery('.mod_km_categories ul li a.hides').live('click',function(){
