...
jQuery(document).ready(function(){
	...
	jQuery('.photo .image-preview').live('click',function()
	{
		jQuery('body').append('<div id="popup-overlay_imageparams"></div>');
		jQuery(this).parent().next().show();
	});	
	
	jQuery('.popupForm .displace label').live('click',function(){	
	...
	jQuery('.popupForm .watermark label').live('click',function(){	
	...
	jQuery('.photo .del-img').live('click',function(){
